    ...
    : CustomCategory(AngleCategory, i18n("Angle"), i18n("Angle"))
{
    ...
    addDefaultUnit(CustomUnit(AngleCategory,
                              Degree,
                              1,
    ...
    addCommonUnit(CustomUnit(new RadiansUnitPrivate(AngleCategory,
                                                    Radian,
                                                    1.0,
    ...
    addUnit(CustomUnit(AngleCategory,
                       Gradian,
                       360.0 / 400.0,
    ...
    addCommonUnit(CustomUnit(AngleCategory,
                             ArcMinute,
                             1.0 / 60.0,
                             i18nc("angle unit symbol", "'"),
