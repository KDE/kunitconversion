...
UnitCategory ThermalGeneration::makeCategory()
{
    ...
    d->addDefaultUnit(UnitPrivate::makeUnit(ThermalGenerationCategory,
                              ...
                              i18nc("unit synonyms for matching user input", "watt per cubic meter;W/m³;W/m3;W/m^3"),
                              symbolString,
    ...
    d->addCommonUnit(UnitPrivate::makeUnit(ThermalGenerationCategory,
                             ...
                             i18nc("unit synonyms for matching user input", "btu per hour per cubic foot;Btu/hr/ft³;Btu/hr/ft3;Btu/hr/ft^3;Btu/ft³/hr;Btu/ft^3/hr;Btu/ft3/hr"),
                             symbolString,
